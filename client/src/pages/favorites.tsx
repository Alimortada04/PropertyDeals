            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex bg-gray-100 rounded-md p-1">
                <Button
                  ...
                  size="sm"
                  className={`flex items-center justify-center h-8 w-8 rounded-md transition-all duration-200 ${viewMode === "grid" ? "bg-[#803344] text-white hover:bg-[#803344]/90" : "bg-transparent text-gray-500 hover:bg-gray-200"}`}
                ...
                <Button
                  ...
                  size="sm"
                  className={`flex items-center justify-center h-8 w-8 rounded-md transition-all duration-200 ${viewMode === "list" ? "bg-[#803344] text-white hover:bg-[#803344]/90" : "bg-transparent text-gray-500 hover:bg-gray-200"}`}
