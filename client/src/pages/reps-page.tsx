    ...
    <div className="flex flex-col min-h-screen pb-12 bg-white">
      ...
      <div className="flex-grow mt-6">
        <div className="container mx-auto px-4">
          ...
          {/* Results Grid - Responsive column layout with uniform heights */}
          {filteredReps.length > 0 ? (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 md:gap-4 lg:gap-5 auto-rows-fr">
