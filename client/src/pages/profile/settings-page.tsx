    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6 lg:sticky lg:top-24">
            <div className="flex flex-col items-center">
              <Avatar className="h-24 w-24 mb-3">
                ...
                <AvatarFallback className="bg-[#09261E] text-white text-3xl">
                  {profileData.full_name?.charAt(0) || profileData.username?.charAt(0) || "U"}
                </AvatarFallback>
              </Avatar>
              <h2 className="text-xl font-bold">{profileData.full_name || "Your Name"}</h2>
              <p className="text-gray-600 mb-2">@{profileData.username || "username"}</p>
              
              <div className="space-y-1 text-sm text-gray-500 w-full mt-3">
                ...
                <div className="flex items-center">
                  ...
                  <span>{profileData.business_name || "No business name set"}</span>
                </div>
              </div>
              ...
              <div className="w-full mt-6 pt-6 border-t border-gray-100">
                <Link href="#" className="text-sm text-[#09261E] hover:underline flex items-center justify-center">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold text-[#09261E] mb-6">Profile Settings</h1>
            ...
            <Accordion type="single" collapsible className="w-full" defaultValue="account">
              ...
              <AccordionItem value="account" className="border-b">
                <AccordionTrigger className="px-6 py-4 hover:no-underline">
                  <div className="flex items-center">
                    <Settings className="h-5 w-5 mr-3 text-[#09261E]" />
                    <span className="text-xl font-semibold">Account Settings</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="pt-2 px-6 pb-6">
                  <p className="text-gray-600 mb-6">Update your personal information and account details</p>
              ...
              <AccordionItem value="profile" className="border-b">
                <AccordionTrigger className="px-6 py-4 hover:no-underline">
                  <div className="flex items-center">
                    <User className="h-5 w-5 mr-3 text-[#09261E]" />
                    <span className="text-xl font-semibold">Profile</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="pt-2 px-6 pb-6">
                  <p className="text-gray-600 mb-6">Manage your professional experience, identity, and social media links</p>
              ...
              <AccordionItem value="property" className="border-b">
                <AccordionTrigger className="px-6 py-4 hover:no-underline">
                  <div className="flex items-center">
                    <Building className="h-5 w-5 mr-3 text-[#09261E]" />
                    <span className="text-xl font-semibold">Property Preferences</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="pt-2 px-6 pb-6">
                  <p className="text-gray-600 mb-6">Set your property preferences and investment criteria</p>
              ...
              <AccordionItem value="professional" className="border-b">
                <AccordionTrigger className="px-6 py-4 hover:no-underline">
                  <div className="flex items-center">
                    <Users className="h-5 w-5 mr-3 text-[#09261E]" />
                    <span className="text-xl font-semibold">Professional Preferences</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="pt-2 px-6 pb-6">
                  <p className="text-gray-600 mb-6">Set preferences for working with various professionals</p>
