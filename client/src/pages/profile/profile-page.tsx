...
function ProfilePage() {
  ...
  const { data: buyerProfile, isLoading, error } = useQuery({
    ...
    queryFn: async () => {
      ...
      // Fetch profile directly from Supabase using UUID as primary key
  ...
  const updateProfileMutation = useMutation({
    mutationFn: async (data: any) => {
      ...
      if (buyerProfile) {
        ...
        // Create new profile with Supabase user ID as primary key
        const profileData = {
          id: supabaseUser.id,
          ...data,
          created_at: new Date().toISOString(),
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-1">
        ...
        <div className="hidden md:block w-[220px] fixed top-0 left-16 bottom-0 bg-white border-r flex flex-col shadow-sm h-screen">
