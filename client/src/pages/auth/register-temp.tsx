        ...
        {verificationRequired ? (
          ...
          <div className="w-full">
            ...
            <div className="flex justify-center mb-4">
              <div className="w-20 h-20 rounded-full bg-[#09261E]/10 flex items-center justify-center">
            ...
            {/* Username Box */}
            {generatedUsername && (
              <div className="bg-[#09261E]/5 p-4 rounded-lg border border-[#09261E]/10 mb-6">
                <p className="text-sm text-gray-700 mb-2">Your username will be:</p>
                <div className="flex items-center bg-white p-2 rounded border border-gray-200">
                  <code className="text-[#135341] flex-grow font-medium">{generatedUsername}</code>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => {
            ...
            <div className="mb-6">
              <p className="text-sm text-center text-gray-500 mb-3">Need help checking your inbox?</p>
              <div className="grid grid-cols-2 gap-2 md:grid-cols-4">
                <a 
                  href="https://mail.google.com" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-1.5 p-2 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 transition-colors text-sm"
                >
            ...
            <Button 
              ...
              className="w-full h-12 bg-[#09261E] hover:bg-[#0c3a2d] text-white font-medium"
            >
              Go to Sign In
