                        ...
                        <div className="space-y-4 mb-5">
                          ...
                          <div>
                            ...
                            <div className="relative">
                              ...
                              <Input
                                type="text"
                                defaultValue={(property.price * 0.05).toFixed(
                                  0,
                                )}
                                className="bg-white pl-7 border-gray-300 focus:border-[#135341] focus:ring-[#135341]/20"
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <div className="relative">
                                ...
                                <Input
                                  type="text"
                                  defaultValue={(property.price * 0.02).toFixed(
                                    0,
                                  )}
                                  className="bg-white pl-7 border-gray-300 focus:border-[#135341] focus:ring-[#135341]/20"
                            ...
                            <div>
                              ...
                              <div className="relative">
                                ...
                                <Input
                                  type="text"
                                  defaultValue={(property.price * 0.06).toFixed(
                                    0,
                                  )}
                                  className="bg-white pl-7 border-gray-300 focus:border-[#135341] focus:ring-[#135341]/20"
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <Button
                            ...
                            onClick={() => {
                              ...
                              const purchasePrice =
                                parseFloat(purchasePriceStr) || property.price;
                              const repairCosts =
                                parseFloat(repairCostsStr) ||
                                property.price * 0.05;
                              const arv =
                                parseFloat(arvStr) || property.price * 1.2;
                              const holdingCosts =
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              const purchasePrice =
                                parseFloat(purchasePriceStr) || property.price;
                              const monthlyRent =
                                parseFloat(rentStr) || property.price * 0.008;
                      ...
                      <table className="w-full min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          ...
                          <tr>
                            ...
                            <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                              ${(property.price * 0.85).toLocaleString()}
                            </td>
                            <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-500">
                              County Records
                            </td>
