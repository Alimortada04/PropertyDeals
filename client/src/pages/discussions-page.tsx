...
function StickyPostComposer({ 
  ...
  return (
    <div 
      ref={composerRef}
      className={`${isSticky ? 'sticky bottom-0' : 'relative'} z-30 mb-0 bg-transparent ${className || ''} ${isAtBottom ? 'border-t-0' : ''}`}
      style={{ 
...
export default function DiscussionsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 pb-20 pt-20 md:pt-8" data-content-area>
      {/* Breadcrumbs */}
      <div className="mb-3">
        <Breadcrumbs />
      </div>
