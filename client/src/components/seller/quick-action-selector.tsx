...
export function QuickActionSelector() {
  ...
  return (
    <div 
      id="quick-action-fab" 
      ref={fabRef}
      className="fixed z-50 right-4 sm:right-6 bottom-[72px] sm:bottom-[32px] md:bottom-[40px] lg:bottom-[48px] xl:bottom-[56px]"
          ...
          <div className="absolute bottom-7 right-7">
            ...
            >
              ...
              >
                ...
                <span className="absolute -top-8 -left-20 bg-black/80 backdrop-blur-sm text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                  List Property
                </span>
              </Button>
            </motion.div>
