  ...
  return (
    ...
    >
      ...
      <div className="w-full px-0 py-4 shadow-sm">
        <div className="flex flex-row items-center gap-3 max-w-full pl-4 pr-4 md:pl-16 mx-auto">
          {/* Location Search */}
      ...
      {selectedFilters.length > 0 && (
        <div className="bg-white border-b border-gray-100">
          <div className="w-full px-0 py-2">
            <div className="flex flex-wrap gap-2 items-center max-w-full pl-4 pr-4 md:pl-16 mx-auto">
      ...
      {tabs.length > 0 && (
        <div className={cn(
          ...
          <div className="overflow-x-auto py-2 max-w-full pl-4 pr-4 md:pl-16 mx-auto">
            <Tabs 
