...
// Sample FAQ questions and answers - same as in faq-page.tsx
const faqData = [
  {
    id: "buying",
    category: "Buying",
...
export function HelpFAQ() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-[#09261E] mb-2">Frequently Asked Questions</h2>
      ...
      {filteredFAQs.length > 0 ? (
        filteredFAQs.map((category) => (
          <div key={category.id} className="mb-8">
            <h3 className="text-xl font-semibold text-[#09261E] mb-4">{category.category}</h3>
